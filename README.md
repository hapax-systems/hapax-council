...
>
> This line states the licence, not the holder. `LICENSE` is the authority on who holds the
> copyright; changing that is an ownership determination and does not belong in a legibility change.
