...
Public asset CDN for [hapax-council](https://github.com/hapax-systems/hapax-council).

Contents are mirrored from `assets/aesthetic-library/` in the council repo by the
[`hapax-assets-publisher` daemon](https://github.com/hapax-systems/hapax-council/tree/main/agents/hapax_assets_publisher);
...
@font-face {
  ...
  src: url("https://hapax-systems.github.io/hapax-assets/fonts/Px437_IBM_VGA_8x16.woff2?sha=0cc1138b") format("woff2");
}
```
