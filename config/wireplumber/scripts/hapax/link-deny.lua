...
local FAIL_CLOSED_FORBIDDEN_LINKS = {
  ["hapax-private-playback:output_FL|hapax-livestream-tap:playback_FL"] = true,
  ["hapax-private-playback:output_FR|hapax-livestream-tap:playback_FR"] = true,
  ["hapax-private-monitor-capture:output_FL|hapax-livestream-tap:playback_FL"] = true,
  ["hapax-private-monitor-capture:output_FR|hapax-livestream-tap:playback_FR"] = true,
  ["hapax-notification-private-playback:output_FL|hapax-livestream-tap:playback_FL"] = true,
  ["hapax-notification-private-playback:output_FR|hapax-livestream-tap:playback_FR"] = true,
  ["hapax-pc-loudnorm-playback:output_FL|hapax-livestream-tap:playback_FL"] = true,
  ["hapax-pc-loudnorm-playback:output_FR|hapax-livestream-tap:playback_FR"] = true,
  ["hapax-private-playback:output_FL|hapax-broadcast-master-capture:input_FL"] = true,
  ["hapax-private-playback:output_FR|hapax-broadcast-master-capture:input_FR"] = true,
  ["hapax-private-playback:output_FL|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX2"] = true,
  ["hapax-private-playback:output_FR|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX3"] = true,
  ["hapax-notification-private-playback:output_FL|hapax-broadcast-master-capture:input_FL"] = true,
  ["hapax-notification-private-playback:output_FR|hapax-broadcast-master-capture:input_FR"] = true,
  ["hapax-notification-private-playback:output_FL|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX2"] = true,
  ["hapax-notification-private-playback:output_FR|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX3"] = true,
  ["hapax-pc-loudnorm-playback:output_FL|hapax-broadcast-master-capture:input_FL"] = true,
  ["hapax-pc-loudnorm-playback:output_FR|hapax-broadcast-master-capture:input_FR"] = true,
  ["hapax-pc-loudnorm-playback:output_FL|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX2"] = true,
  ["hapax-pc-loudnorm-playback:output_FR|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0:playback_AUX3"] = true,
...
local FAIL_CLOSED_BOUNDARY_PAIRS = {
  ["hapax-private-playback|hapax-livestream-tap"] = true,
  ["hapax-private-monitor-capture|hapax-livestream-tap"] = true,
  ["hapax-notification-private-playback|hapax-livestream-tap"] = true,
  ["hapax-pc-loudnorm-playback|hapax-livestream-tap"] = true,
  ["hapax-private-playback|hapax-broadcast-master-capture"] = true,
  ["hapax-notification-private-playback|hapax-broadcast-master-capture"] = true,
  ["hapax-notification-private-playback|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0"] = true,
  ["hapax-pc-loudnorm-playback|hapax-broadcast-master-capture"] = true,
  ["hapax-pc-loudnorm-playback|alsa_output.usb-MOTU_UltraLite-mk5_UL5LFEC2B0-00.pro-output-0"] = true,
