...
async def authority_utilization() -> dict:
    ...
    from logos.data.governance import collect_authority_utilization
...
async def consent_lifecycle() -> dict:
    ...
    from logos.data.governance import collect_consent_lifecycle
...
async def carrier_flow() -> dict:
    ...
    from logos.data.governance import collect_carrier_flow
