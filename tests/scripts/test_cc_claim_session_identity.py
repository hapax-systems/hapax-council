...
def test_trailing_newline_session_id_is_refused_before_any_claim_write(
    tmp_path: Path,
) -> None:
    home = tmp_path / "home"
    note = _write_task(home, "task-newline")

    result = _claim(home, "task-newline", session_id=f"{_UUID}\n")
