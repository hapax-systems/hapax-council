"""Tests for logos.voice — greeting and operator name resolution."""
...
def test_operator_name_fallback():
    ...
    with patch("logos.voice.operator_name", side_effect=Exception("no profile")):
...
def test_greeting_morning():
    ...
    with patch("logos.voice.datetime") as mock_dt:
