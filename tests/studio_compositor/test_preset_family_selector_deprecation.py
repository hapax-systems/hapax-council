...
KNOWN_IMPORTERS: frozenset[str] = frozenset(
    {
        ...
        "agents/parametric_modulation_heartbeat/__init__.py",
        ...
        "tests/agents/parametric_modulation_heartbeat/test_walk.py",
        "tests/studio_compositor/test_fx_tick_governance_stance.py",
        "tests/studio_compositor/test_preset_recruitment_consumer.py",
        "tests/studio_compositor/test_preset_recruitment_role_bias.py",
    }
)
