...
def test_non_3d_compositor_does_not_start_director_runtime(monkeypatch) -> None:
    ...
    assert lifecycle._start_3d_director_runtime(compositor) is False
    assert compositor._aoa_loader is None
