"""Tests for logos formatters: render_infra_detail, render_scout_detail.
...
from logos.data.infrastructure import ContainerStatus
from logos.data.scout import ScoutData, ScoutRecommendation
from logos.formatters import render_infra_detail, render_scout_detail
