...
#[tauri::command]
pub async fn browser_screenshot<R: Runtime>(app: AppHandle<R>) -> Result<String, String> {
    let state = app.try_state::<BrowserState>().ok_or("Browser not ready")?;
...
#[tauri::command]
pub async fn browser_click<R: Runtime>(app: AppHandle<R>, selector: String) -> Result<(), String> {
    let state = app.try_state::<BrowserState>().ok_or("Browser not ready")?;
...
#[tauri::command]
pub async fn browser_press_key<R: Runtime>(app: AppHandle<R>, key: String) -> Result<(), String> {
    let state = app.try_state::<BrowserState>().ok_or("Browser not ready")?;
