...
- **Bounded per-host memory policy**: `config/root-required/oom-host-profiles.tsv`
  ...
  Podium's selected app/UID sources are the existing canonical `systemd/**`
  package files; Appendix's alternate values live under
