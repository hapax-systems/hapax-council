...
- **Other OOM overrides**: root-owned recovery daemons retain PID-1-managed negative scores; container and hardware-specific policy remains documented beside its installer. Delegated PipeWire/WirePlumber services remain at `100`.
