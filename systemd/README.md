...
**Topology:** <!-- topology-inventory:services -->292<!-- /topology-inventory:services --> services, <!-- topology-inventory:timers -->141<!-- /topology-inventory:timers --> timers, 4 paths, 3 targets. Verify with `uv run python scripts/hapax_topology_inventory.py --check`.
