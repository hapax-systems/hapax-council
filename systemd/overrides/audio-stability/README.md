...
The canonical deployable copies live under
`systemd/units/*.service.d/cpu-affinity.conf`. They are installed by the
normal council unit deploy path:
...
For emergency manual activation from this directory:
