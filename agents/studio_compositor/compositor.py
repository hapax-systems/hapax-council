...
_FALLBACK_LAYOUT = Layout(
    ...
    sources=[
        ...
        SourceSchema(
            ...
            tags=["brio", "ir", "screwm", "ward"],
            ward_id="brio-operator-ir",
        ),
        SourceSchema(
            id="brio-room-ir",
            kind="external_rgba",
            ...
            params={
                "natural_w": 340,
                "natural_h": 340,
                "shm_path": "/dev/shm/hapax-compositor/quake-live-ir-brio-room.raw.bgra",
                "sidecar_path": "/dev/shm/hapax-compositor/quake-live-ir-brio-room.raw.json",
                "max_age_s": 8.0,
            },
            tags=["brio", "ir", "screwm", "ward"],
            ward_id="brio-room-ir",
        ),
        SourceSchema(
            id="brio-synths-ir",
            kind="external_rgba",
            ...
            params={
                "natural_w": 340,
                "natural_h": 340,
                "shm_path": "/dev/shm/hapax-compositor/quake-live-ir-brio-synths.raw.bgra",
                "sidecar_path": "/dev/shm/hapax-compositor/quake-live-ir-brio-synths.raw.json",
                "max_age_s": 8.0,
            },
            tags=["brio", "ir", "screwm", "ward"],
            ward_id="brio-synths-ir",
        ),
        SourceSchema(
            id="egress_footer",
            kind="cairo",
