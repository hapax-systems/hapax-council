...
fn main_1() {
    ...
    let surface_presence = smoothstep(0.025, 0.18, luma);
    let speed = clamp(global.u_speed, 0.0, 0.24);
    ...
    let temporal_strength = surface_presence * clamp(0.18 + speed * 1.35, 0.0, 0.46);
