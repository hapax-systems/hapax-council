...
dispatch through the central Logos control surface. The adapter owns no
compositor / studio state of its own; every button press resolves to a single
``(command, args)`` pair loaded from ``config/streamdeck.yaml``.
