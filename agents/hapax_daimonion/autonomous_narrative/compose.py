...
def _build_prompt(
    ...
    return (
        ...
        "AMBIENT register permitted: 'Recruitment threshold halved.', "
        "'Stimmung cautious — consent gates elevated.', "
        "'DMN pulse completed. Grounding quality 0.73.'\n"
        "AMBIENT register forbidden: 'Happy to help with that.', "
        "'Always here for you.', 'Hapax experiences wonder.', "
        "any audience address, any engagement verb.\n"
        f"{referent_clause}\n"
