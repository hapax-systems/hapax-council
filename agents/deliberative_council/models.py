...
class CouncilConfig(BaseModel):
    ...
    # panel is 6 members across 5 families (anthropic x2, google, mistral,
    # deepseek, zhipu/glm). deepseek + glm were added 2026-06-20 for
    # cap-resilient diversity. The perplexity seat was removed 2026-09-25
    # with the Sonar Chat Completions routes. The floor is FAMILY COVERAGE,
    # not a tuned magic constant; it is
    ...
    #     scored result (default 4 — now of 5; tolerates losing 1 family).
