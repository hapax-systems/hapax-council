...
(* Stage metadata SSOT: docs/formal/sdlc-stage-metadata.yaml. Deterministic  *)
(* tests compare Stages, Terminal, Blocked, Next, and Fall exactly; the TLA  *)
(* remains an advisory formal consumer and does not perform file I/O.       *)
(*                                                                          *)
