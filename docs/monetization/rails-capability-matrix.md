...
| **Treasury Prime** | HMAC SHA-256 (`X-Signature`) + body-borne `data.id` | Negotiated banking-as-API tier | `https://api.treasuryprime.com/...` | `incoming_ach.create` (Phase 0); `transaction.create` deferred to Phase 1 | API stable | wired ✓ |
