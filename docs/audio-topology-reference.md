...
| IN 2 | `pro-input-0:capture_AUX1` (mono) | Cortado MKII contact mic | perceptual / quarantine (`contact_mic`; NOT broadcast — see `config/perception-registry.yaml` cortado.hw_source) |
