...
def capture_witnesses(
    ...
    *,
    ...
    captures: dict[str, object] = {
        "obs": _capture(["spectacle", "-b", "-n", "-o", str(obs_path)], obs_path, timeout_s=timeout_s)
    }
...
def run_matrix(args: argparse.Namespace) -> int:
    ...
    if args.restore_camera:
        _write_lines(args.game_data, {"camera-manual.txt": "0.0000", "effect-review-preset.txt": "0"})
