...
TEXTURES = {
    ...
    "city4_2": {"color": (4, 4, 6), "noise": 0, "pattern": "hard_void", "palette": "scroom", "size": 128},
    "ground1_6": {"color": (4, 4, 6), "noise": 0, "pattern": "hard_void", "palette": "scroom", "size": 128},
    "sky4": {"color": (4, 4, 6), "noise": 0, "pattern": "hard_void", "palette": "scroom", "size": 128},
    "metal5_2": {"color": (4, 4, 6), "noise": 0, "pattern": "hard_void", "palette": "scroom", "size": 128},
    "scroom": {"color": (4, 4, 6), "noise": 0, "pattern": "hard_void", "palette": "scroom", "size": 128},
    "cmp_floor": {"color": (4, 4, 6), "noise": 0, "pattern": "compositor_floor", "palette": "scroom", "size": 256},
    "cmp_ceil": {"color": (4, 4, 6), "noise": 0, "pattern": "compositor_ceiling", "palette": "scroom", "size": 256},
    "cmp_wall": {"color": (4, 4, 6), "noise": 0, "pattern": "compositor_wall", "palette": "scroom", "size": 256},
    # R&D / Research band handles: procedural signal surfaces, never scenic materials.
    "r_percep": {"color": (38, 46, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "r_cognit": {"color": (38, 46, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "r_comm": {"color": (38, 46, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "r_express": {"color": (38, 46, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "r_ground": {"color": (38, 46, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "s_percep": {"color": (34, 44, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "s_cognit": {"color": (34, 44, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "s_comm": {"color": (34, 44, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "s_express": {"color": (34, 44, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
    "s_ground": {"color": (34, 44, 62), "noise": 1, "pattern": "signal_panel", "palette": "scroom", "size": 128},
...
ACTIVE_WARD_TEXTURES = {
    name
    for name in MEDIA_MOUNTS_BY_TEXTURE
...
def generate_pixel_data(
    ...
    random.seed(seed)
    pixels = bytearray()
    palette = build_scroom_palette() if palette_mode == "scroom" else build_monochrome_palette(color)
    ...
    for y in range(height):
        for x in range(width):
            ...
            if pattern == "stone_blocks":
                ...
                # Matte receiver substrate. Directional/path information must
                # be carried by in-world wards, live textures, and dynamic
                # lightfields; static dots and lattices read as structure junk.
                base = 4

            elif pattern == "compositor_ceiling":
                # Same matte receiver as the floor: no overhead truss graph
                # until it is an authored entity or drift/lightfield behavior.
                base = 4

            elif pattern == "compositor_wall":
                # Neutral enclosure receiver. Ward mounts and drift effects
                # provide all visible structure.
                base = 4
